...
public record CreateBookUseCase(TransactionDelegate transactionDelegate, BookRepository bookRepository)
        implements CreateUseCase<BookCreationRequest, BookEntity> {

    @Override
    public BookEntity execute(BookCreationRequest request) throws DomainException {
